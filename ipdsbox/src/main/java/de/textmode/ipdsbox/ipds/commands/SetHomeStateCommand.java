...
public final class SetHomeStateCommand extends IpdsCommand {
    ...
    /**
     * Constructs a {@link SetHomeStateCommand} with default values.
     */
    public SetHomeStateCommand() {
        super(IpdsCommandId.SHS);
    }

    /**
     * Constructs the {@link SetHomeStateCommand} from the given {@link IpdsByteArrayInputStream}.
     */
